...
def FCN8s(n_class = 7, path=None, width=512, height=512):
    img_input = Input(shape = (width, height, 3))

    b3, b4, b5 = vgg16_cnn(img_input, path)
    o = b5
    ...
    o = Conv2DTranspose(n_class, kernel_size=(4, 4), strides=(2, 2), padding='same')(o)

    o2 = b4 
    o2 = Conv2D(n_class, (1, 1), name='conv9')(o2)
    o = Add()([o, o2])
    
    o = Conv2DTranspose(n_class, kernel_size=(4, 4), strides=(2, 2), padding='same')(o)

    o2 = b3 
    o2 = Conv2D(n_class, (1, 1), name='conv10')(o2)
    o = Add()([o, o2])
    
    o = Conv2DTranspose(n_class, kernel_size=(16, 16), strides=(8, 8), padding='same')(o)
    o_shape = Model(img_input, o).output_shape
    o_height, o_width = o_shape[1], o_shape[2]

    o = Activation('softmax')(o)
    
    fcn8s= Model(img_input, o)
    #plot_model(fcn8s, to_file='FCN8s.png')
    return fcn8s

if __name__ == '__main__':
    path = '../model/'
    model = FCN8s(path=path)
